...
public final class ConfigHelper {
    ...
    public static String getAppBaseJspPath(){
        return PropsUtil.getString(CONFI_PROPS,ConfigConstant.APP_JSP_PATH+"/WEB-INF/view/");
    }

    public static String getAppAssetPath(){
        return PropsUtil.getString(CONFI_PROPS,ConfigConstant.APP_ASSET_PATH+"/asset/");
    }
